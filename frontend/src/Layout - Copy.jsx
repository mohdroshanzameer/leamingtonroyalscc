...
export default function Layout({ children, currentPageName }) {
  ...
  useEffect(() => {
    ...
    api.auth.me()
      ...
      .catch((err) => {
        if (mounted) {
          console.log('[Layout] No authenticated user:', err?.message);
          setUser(null);
          setUserLoaded(true);
        }
      });
    ...
    return (
      <div className="min-h-screen flex" style={{ backgroundColor: colors.background }}>
        ...
        <div className="flex-1 ml-64 flex flex-col min-h-screen">
          ...
          {/* Player Profile Banner - Desktop */}
          {userLoaded && user && <PlayerProfileBanner user={user} />}
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.background }}>
                ...
                {user && canViewFinance(user) && (
                  <>
                    ...
                    <NavLink 
                                              ...
                                              page="Sponsorships" 
                                              icon={Building2} 
                                              customStyle={{ backgroundColor: 'rgba(251,146,60,0.15)', color: '#fb923c' }}
                                              compact
                                            />
                  </>
                )}
      ...
      {/* Player Profile Banner - Mobile */}
      {userLoaded && user && (
        <div className="fixed top-16 left-0 right-0 z-30">
          <PlayerProfileBanner user={user} />
        </div>
      )}
